...
import { restful_url, client_url, dwollaApi } from "../../EndPoint";
...
export const SAVE_RECIEVE_ONLY_FUNDING_SOURCE =
  "SAVE_RECIEVE_ONLY_FUNDING_SOURCE";
export const SAVE_RECIEVE_ONLY_FUNDING_SOURCE_ERR =
...
export function createPersonalUser(data) {
  ...
  return (dispatch) => {
    axios
      .post(`${client_url}${dwollaApi.varified_personal_customer}`, data)
...
export function getFundingSourceToken(data) {
  ...
  return (dispatch) => {
    axios
      .post(`${client_url}${dwollaApi.funding_source_token}`, data)
...
export function getCustomerDetails(data) {
  ...
  return (dispatch) => {
    axios
      .post(`${client_url}${dwollaApi.customer_detail}`, data)
...
export const saveFundingSource = (data) => {
  ...
  return (dispatch) => {
    ...
    docRef
      .set({ fundingSource: url }, { merge: true })
      .then(function() {
...
export function getCustomerTransactions(data) {
  ...
  return (dispatch) => {
    axios
      .post(`${client_url}${dwollaApi.customer_transaction}`, data)
...
export const addFundingSourceForm = (data) => {
  ...
  return (dispatch) => {
    axios
      .post(`${client_url}${dwollaApi.customer_add_funding}`, data)
      .then(function(res) {
        console.log("Transaction success!", res);
