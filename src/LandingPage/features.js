        ...
        <div className={classes.featuresContainer}>
            ...
            <Grid container spacing={40} className={classes.features}>
                <Grid item sm={12} lg={4} md={6} style={{overflow: 'hidden'}} className='feature'>
                    <img style={{ 'maxWidth': '256px', 'maxHeight': '192px'}} src={task} alt="task"/>
                ...
                <Grid item sm={12} lg={4} md={6}>
                    <img style={{ 'maxWidth': '256px', 'maxHeight': '192px'}} src={paperless} alt="mobile"/>
                ...
                <Grid item sm={12} lg={4} md={6}>
                    <img style={{ 'maxWidth': '256px', 'maxHeight': '192px'}} src={payroll} alt="payroll"/>
                ...
                <Grid item sm={12} lg={4} md={6}>
                    <img style={{ 'maxWidth': '256px', 'maxHeight': '192px'}} src={timetrack} alt="time tracking"/>
                ...
                <Grid item sm={12} lg={4} md={6}>
                    <img style={{ 'maxWidth': '256px', 'maxHeight': '192px'}} src={tax} alt="tax"/>
                ...
                <Grid item sm={12} lg={4} md={6}>
                    <img style={{ 'maxWidth': '256px', 'maxHeight': '192px'}} src={alerts} alt="alerts"/>
