  ...
  return (
    <div className={classes.pricingContainer}>
      <div className="lp-pricing-title">
        ...
        <p className={classes.pricingTitleSub}>
          No Contract | No Sign-up Fee | No Direct Deposit Fee | No Filing Fees
        </p>
      </div>
        ...
        <div className="cKOUfV">
          <div className="lp-pricing-cards-container">
            <div className="lp-pricing-card">
              <div className="">
                <p>
                  <b>Our 30-day guarantee</b> if you decide to close your
                  account within 30 days of signing up, we`ll refund 100% of
                  your payment
                </p>
                <br />
            ...
            <div className="lp-pricing-card">
              ...
              <div className="lp-card2Body">
                <ul className="lp-card2List">
                  <li className="lp-card2ListItems">
                    <span className="lp-listStyleIconContainer">
                      <svg
                        className="lp-listStyleIcon"
                        xmlns="http://www.w3.org/2000/svg"
                        viewBox="0 0 24 24"
                      >
                        <path
                          d="M3.84 14.25H8.91C9.13278 14.25 9.34644 14.3385 9.50397
                                            ...
                                            13.8464 3.24603 14.004C3.40356 14.1615 3.61722 14.25 3.84 14.25Z"
                          fill="currentColor"
                        ></path>
                      </svg>
                    </span>
                ...
                <div style={{ display: "flex", justifyContent: "center" }}>
                  <a
                    href="/employeer/signup"
                    className="lp-signup-button-pricing"
                  >
                    SignUp
                  </a>
                  <br />
                ...
                <p style={{ textAlign: "center" }}>
                  <span className="lp-cars2Footer">
                    *Additional Employee $10/month <br /> ** Additional options
                    Extra $.
                  </span>
                </p>
              </div>
            ...
            <div className="lp-pricing-card">
              <p className="">
                <b>AARP and Veteran Discount</b> We offer eligible AARP and
                Veterans discount of 10% at SignUp.
              </p>
            </div>
          </div>
        </div>
