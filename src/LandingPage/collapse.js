...
const FAQC = (props) => {
    ...
    const dataList = [{
        ...
        text: `if you hired someone to do household work (work done in or around your primary home)
        ...
        text: `Here are five core obligations as a household employer. <br/>
                <ol>
    ...
    },
    {
        ...
        text: `Every pay period household employer taxes are 1) Payroll tax withheld from the
    ...
    },
    {
        ...
        text: `<b>Form SS-4:</b> Fill out Form SS-4 or apply online through the IRS to obtain your federal Employee
    ...
    },
    {
        ...
        text: `Depending on your residency and tax situation many laws apply to the household employer. Please consult
    ...
    },
    {
        ...
        text: `Depending on where you live</b> , states require household employers to carry a workers’ compensation policy
...
export default withStyles(styles)(FAQC);
