          ...
          <CardBody>
            ...
            >
              ...
              <ListItem>
                ...
                <Tooltip TransitionComponent={Zoom} title="Select your currency">
                  <IconButton className="helpButton">
                    <img className="helpImage" src={HelpIcon} alt="help"/>
                  </IconButton>
                </Tooltip>
              ...
              <ListItem>
                ...
                <Tooltip TransitionComponent={Zoom} title="Select a date when your pay period starts">
                  <IconButton className="helpButton">
                    <img className="helpImage" src={HelpIcon} alt="help"/>
                  </IconButton>
                </Tooltip>
              ...
              <ListItem>
                ...
                <Tooltip TransitionComponent={Zoom} title="Turn on/off fingerprint authentication">
                  <IconButton className="helpButton">
                    <img className="helpImage" src={HelpIcon} alt="help"/>
                  </IconButton>
                </Tooltip>
