...
const forgetWait = useSelector((state)=>state.employeeUserReducer.forgetWait)
...
if (forgetWait === "move") {
  props.history.push("/employee/login");
}
},[nextProps])
...
// })(connect(mapStateToProps, { startRessetPassword })(withRouter(LogInForm)));
