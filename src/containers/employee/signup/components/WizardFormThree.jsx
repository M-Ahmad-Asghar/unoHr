...
const WizardFormOne = ({ handleSubmit, previousPage,getPlan }) => (
  <form className="form form--horizontal wizard__form" onSubmit={handleSubmit}>
    <h3 className="wizard__title">Payment Method</h3>
    <div className="form__form-group">
      ...
      <div className="form__form-group-field">
        <Field
          ...
          type="text"
          options={[
                { value: 'basic-$39', label: 'Basic-$39' },
                { value: 'standard-$99', label: 'Standard-$99' },
              ]}
          placeholder="Choose plan"
          onChange={(e)=>{getPlan(e.value)}}
        />
      </div>
    </div>
    <div className="form__form-group">
